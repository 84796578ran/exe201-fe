...
class PostDetailScreenProvider extends StatefulWidget {
  static const path = '/post-detail';
  final Post post;

  const PostDetailScreenProvider({super.key, required this.post});

  @override
  State<PostDetailScreenProvider> createState() => _PostDetailScreenState();
}

class _PostDetailScreenState extends State<PostDetailScreenProvider> {
